...
from app_config import(
    sn_token_single_def, sn_token_prefix_def, sn_token_suffix_def,
    ...
    K_NUM_MM_SINGLE_TOKEN_REGEX, K_NUMXNUM_MM_SINGLE_TOKEN_REGEX, NUM_KALIBRU_SINGLE_TOKEN_REGEX,NUMXNUM_KALIBRU_SINGLE_TOKEN_REGEX,MARKER_KCAL_DEF, MARKER_K_ABBR_DEF
)
...
caliber_paterns_config  = generate_caliber_patterns()
